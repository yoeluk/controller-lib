...
const (
	...
	MessageResourceExists = "Resource %q already exists and is not managed by Rdbs"
...
type Controller struct {
	...
	rdsbdsLister  listers.RdsdbLister
...
func NewController(
	...
	fooInformer informers.RdsdbInformer) *Controller {
